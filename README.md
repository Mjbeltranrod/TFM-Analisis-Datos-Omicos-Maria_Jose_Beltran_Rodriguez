# TFM-Analisis-Datos-Omicos-Maria_Jose_Beltran_Rodriguez
Este repositorio contiene el código en R utilizado para la curación e integración de cohortes públicas, el preprocesamiento de datos transcriptómicos, la inferencia del microambiente tumoral y los análisis de supervivencia realizados en el marco de un Trabajo Fin de Máster.

Título del trabajo: Integración de datos transcriptómicos y clínicos para la predicción del riesgo de recurrencia en cáncer de colon estadio II: hacia una decisión terapéutica personalizada 
