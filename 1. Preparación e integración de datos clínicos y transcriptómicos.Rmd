...
## Procesamiento de datos clínicos y técnicos 
...
# Columnas categóricas ("UK" si no hay datos)
cat_cols <- c(
...
# Estandarizar Gender
datos_total$Gender <- toupper(datos_total$Gender)  
...
# Busca todos los archivos .CEL.gz dentro de las subcarpetas
...
# Cálculo de la desviación estándar por filas
...
# Se ve cuantos genes necesita CIBESORTx que no están presentes en exp_HG.
genes_lm22 <- trimws(rownames(lm22)) 
# Comrpobación del dataframe exp_HG
...
# La mayoría son antiguos nombres que se han mapeado con el nombre actualizado. Solo hay que renombrar.
...
## DESCRIPTIVA COHORTE GLOBAL CONSTRUIDA STAGE II 
...
## DESCRIPTIVA COHORTES INDIVIDUALES 

```{r}
## HTML con la descriptiva de cohortes individuales
st_options(
